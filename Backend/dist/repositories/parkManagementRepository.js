...
exports.query = exports.parkOut = exports.parkIn = exports.uploadPlatePicture = void 0;
...
const pageSize = 10;
const query = (location, timeIn, timeOut, plate_number, lastVisibleId) => __awaiter(void 0, void 0, void 0, function* () {
    let lastVisible = lastVisibleId;
    let query = firebaseConfig_1.db
        .collection('location')
        .doc(location)
        .collection('in')
        .orderBy('time_in')
    ...
    try {
        ...
        console.log(firebaseConfig_1.db
            .collection('location')
            .doc(location)
            .collection('in')
            .doc('B1538BNQ'));
